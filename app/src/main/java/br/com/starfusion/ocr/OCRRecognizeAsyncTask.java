...
import br.com.starfusion.opencv.R;

/**
 * Created by Henrique on 24/11/2016.
 */
...
public class OCRRecognizeAsyncTask extends AsyncTask<Void, Void, Boolean> {
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (handler != null) {
            ...
            if (result) {
                Notification.MessagingStyle.Message message = Message.obtain(handler, R.id.ocr_decode_succeeded, ocrResult);
